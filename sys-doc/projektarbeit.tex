...
\begin{document}
	...
	\begin{table}[h!]
		...
		\label{tab:experiment-setup}
			...
			\midrule
			CPU & \makecell{AMD Ryzen 7 9800X3D \\ (8 Cores, 16 Threads, 4.7 GHz)} & \\
			RAM & 64 GB& \\
			OS & Windows 11 & \\
			Python & 3.13.7 & \\
			\midrule
	...
	\begin{table}[h]
		...
		\begin{tabular}{lrrrrr}
			...
			LinearSVC     & 1.4310 & 22122.28 & 355.05 & 0.0001 & 0    \\
			SGDClassifier & 23.775 & 1331.51  & 340.04 & 0.0020 & 0    \\
			OneClassSVM   & 1.4434 & 21932.09 & 351.42 & 0.0001 & 13.4 \\
			\bottomrule
		\end{tabular}
	\end{table}
	\FloatBarrier
