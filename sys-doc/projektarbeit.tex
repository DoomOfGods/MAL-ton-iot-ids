...
\begin{document}
	...
	\end{equation}
	Der F2-Score $(\beta = 2)$ gewichtet Recall doppelt so stark wie Precision und ist daher für Sicherheitsanwendungen besonders geeignet, da False Negatives erheblich schwerwiegender sind als False Positives.
	...
	Mittels \texttt{psutil} wurde der Peak Memory Usage gemessen. Dies ist besonders relevant für Edge-Deployment, wo Speicher limitiert ist.
	\subsubsection{CPU-Auslastung}
	Die CPU-Auslastung wurde während Training/Inferenz periodisch mittels \texttt{psutil} gesampelt. Dies gibt Aufschluss über Parallelisierungseffizienz und System-Load.
