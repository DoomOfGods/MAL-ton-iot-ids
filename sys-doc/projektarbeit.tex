...
\begin{document}
	...
	\end{enumerate}
	Die Wahl des F2-Scores als Optimierungskriterium reflektiert die Anforderungen von Sicherheitsanwendungen: Ein verpasster Angriff ist kritischer als ein Fehlalarm. Der F2-Score gewichtet Recall doppelt so stark wie Precision.
...
\end{tabular}
	...
	\begin{enumerate}
		...
		\item \textbf{OneClassSVM als Alternative:} Unser OCSVM-Modell weist zwar schlechtere Metriken als unser LinearSVC-Modell auf, jedoch ist anzunehmen, dass es aufgrund des Trainings auf Normalverhalten geeigneter ist, um Angriffe zu erkennen, die nicht durch den TON-IOT Datensatz abgedeckt wurden.
