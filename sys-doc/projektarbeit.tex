...
\begin{document}
	...
	Die Hyperparameter-Optimierung erfolgte mittels Optuna~\cite{akiba2019}, einem Bayesianischen Optimierungsframework. Optuna verwendet den Tree-structured Parzen Estimator (TPE) als Sampling-Strategie, der effizienter ist als Grid Search oder Random Search.
