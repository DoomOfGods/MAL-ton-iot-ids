...
\begin{document}
	...
	\end{enumerate}
	Behandelt werden SVM-basierte Ansätze (SVC, LinearSVC, SGDClassifier, OneClassSVM), Isolation Forest, sowie Boosting-Verfahren auf dem TON-IOT-Network Datensatz.
	...
	\begin{table}[h!]
		...
		\label{tab:experiment-setup}
			...
			\midrule
			CPU & \makecell{AMD Ryzen 7 9800X3D \\ (8 Cores, 16 Threads, 4.7 GHz)} & \makecell{? \\ (6 Cores, 12 Threads, ? GHz)} \\
			RAM & 64 GB& 16GB \\
			OS & Windows 11 & Windows 10 \\
			Python & 3.13.7 & 3.11.9 \\
			\midrule
		\end{tabular}
	\end{table}
	...
	\begin{table}[h]
		...
		\begin{tabular}{lrrrrr}
			...
			\midrule
			SVC           & 260.07 & 121.72   & 439.57 & 0.0278 & 13.0 \\
			LinearSVC     & 1.43   & 22122.28 & 355.05 & 0.0001 & 0    \\
			SGDClassifier & 1.44   & 21932.09 & 351.42 & 0.0001 & 0    \\
			OneClassSVM   & 23.78  & 1331.51  & 340.04 & 0.0020 & 13.4 \\
			\bottomrule
		\end{tabular}
	\end{table}
	\FloatBarrier
