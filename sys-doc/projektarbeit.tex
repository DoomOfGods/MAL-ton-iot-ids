...
\begin{document}
	...
	\begin{table}[h!]
		...
		\label{tab:experiment-setup}
			...
			CPU & \makecell{AMD Ryzen 7 7840HS \\ (8 Cores, 16 Threads, 4.7 GHz)} & \\
			RAM & 64 GB DDR5 & \\
			OS & Windows 11 & \\
			Python & 3.13.7 & \\
			\midrule
...
\end{tabular}
	...
	\begin{enumerate}
		...
		\item \textbf{OneClassSVM als Alternative:} Unser OCSVM-Modell weist zwar schlechtere Metriken auf, als unser LinearSVC-Modell, jedoch könnte es aufgrund des Trainings auf Normalverhalten geeigneter sein, um Angriffe zu erkennen, die nicht durch den TON-IOT Datensatz abgedeckt wurden.
